...
resdir='test_rz_ray_amr_results/'
...
.r getpict
set_device, resdir + 'single_ray.eps', /epe, /land
func='{elaser}*y>1e-6
...
set_device, resdir + 'error_turning_point.eps', /epe, /land
.r getlog
...
set_device, resdir + 'error_energy_deposition.eps', /epe, /land
.r getlog
