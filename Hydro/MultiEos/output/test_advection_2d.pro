...
filename = resdir+'HLLC_*_/GM/*.outs'
set_device,resdir+'HLLC.eps',/eps, /land
.r animate
close_device,/pdf

filename = resdir+'HLLC_*_LIMIT/GM/*.outs'
set_device,resdir+'HLLC_limit.eps',/eps, /land
.r animate
close_device,/pdf

filename = resdir+'HLLC_*_NONCONS/GM/*.outs'
set_device,resdir+'HLLC_noncons.eps',/eps, /land
.r animate
close_device,/pdf

filename = resdir+'HLLC_*_LIMIT_MIXED/GM/*.outs'
set_device,resdir+'HLLC_limit_mixed.eps',/eps, /land
.r animate
close_device,/pdf
...
printf,99,'n godunov g_lim g_noncons g_lim_mix ' $
  ...
  +          '  HLLC c_lim c_noncons c_lim_mix'
...
filename=resdir+'HLLC_40_/GM/z*.outs ' $
  +      resdir+'HLLC_40_LIMIT/GM/z*.outs ' $
  +      resdir+'HLLC_40_NONCONS/GM/z*.outs ' $
  +      resdir+'HLLC_40_LIMIT_*/GM/z*.outs'
.r getpict
errors(12)=calc_error(w0,wref)
errors(13)=calc_error(w1,wref)
errors(14)=calc_error(w2,wref)
errors(15)=calc_error(w3,wref)

printf,99,40,errors,format='(i3,16f7.4)'
...
filename=resdir+'HLLC_80_/GM/z*.outs ' $
  +      resdir+'HLLC_80_LIMIT/GM/z*.outs ' $
  +      resdir+'HLLC_80_NONCONS/GM/z*.outs ' $
  +      resdir+'HLLC_80_LIMIT_*/GM/z*.outs'
.r getpict
errors(12)=calc_error(w0,wref)
errors(13)=calc_error(w1,wref)
errors(14)=calc_error(w2,wref)
...
printf,99,80,errors,format='(i3,16f7.4)'
...
filename=resdir+'HLLC_160_/GM/z*.outs ' $
  +      resdir+'HLLC_160_LIMIT/GM/z*.outs ' $
  +      resdir+'HLLC_160_NONCONS/GM/z*.outs ' $
  +      resdir+'HLLC_160_LIMIT_*/GM/z*.outs'
.r getpict
errors(12)=calc_error(w0,wref)
errors(13)=calc_error(w1,wref)
errors(14)=calc_error(w2,wref)
...
print,"help,w2"
help,w2
printf,99,160,errors,format='(i3,16f7.4)'
...
; The HLLC part of the header of error.dat:
; n HLLC c_lim c_noncons c_lim_mix

set_device,resdir+'error_HLLC.eps',/eps, /land
...
plot_oo,[1e-3,1e-1],[1e-3,1e-1], $
  ...
  ytitle='Relative error', $
  title="Be/Xe/Plastic advection test in 2D"
oplot,2/wlog(*,0),wlog(*,13),psym=-1,thick=3
oplot,2/wlog(*,0),wlog(*,14),psym=-2,thick=3
oplot,2/wlog(*,0),wlog(*,15),psym=-4,thick=3
oplot,2/wlog(*,0),wlog(*,16),psym=-5,thick=3

oplot,[0.0012,0.0017],[0.005,0.005],linestyle=2
xyouts,0.002,0.005,'1st order slope'
oplot,[0.0015],[0.16],psym=1 & xyouts,0.002,0.14,'HLLC'
oplot,[0.0015],[0.04],psym=4 & xyouts,0.002,0.04,'+ #NONCONS'
oplot,[0.0015],[0.08],psym=2 & xyouts,0.002,0.08,'+ #LIMITER'
oplot,[0.0015],[0.02],psym=5 & xyouts,0.002,0.02,'+ #MIXED'
