...
.r getlog
plot_oo,1/wlog(*,0),(wlog(*,1)),xrange=[1e-3,1e-2],yrange=[1e-6,1e-4],$
        psym=-4,charsize=2,thick=3, $
        xtitle='Grid resolution', $
        ytitle='Relative error', $
        title="uniform heat conduction test in rz geometry"
oplot,[1e-3,1e-2],[1e-6,1e-5],linestyle=2,thick=3
xyouts,0.004,0.000003,'1st order slope',charsize=2,charthick=1
close_device
