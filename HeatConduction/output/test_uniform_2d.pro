...
.r getlog
plot_oo,1/wlog(*,0),(wlog(*,1)),xrange=[1e-3,1e-2],yrange=[1e-5,1e-3],$
...
oplot,[1e-3,1e-2],[4e-6,4e-4],linestyle=2,thick=3
xyouts,0.0022,0.000015,'2nd order slope',charsize=2,charthick=1
close_device,/pdf
