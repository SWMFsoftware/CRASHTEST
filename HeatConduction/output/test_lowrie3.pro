...
printf, 99, 'n godunov_cond_error linde_cond_error linde_radcond_error'
...
.r getpict
printf,99,96,calc_error_lowrie3(w0),calc_error_lowrie3(w1),calc_error_lowrie3(w2)
filename=resdir+'*_192/GM/cut*.outs'
.r getpict
printf,99,192,calc_error_lowrie3(w0),calc_error_lowrie3(w1),calc_error_lowrie3(w2)
filename=resdir+'*_384/GM/cut*.outs'
.r getpict
printf,99,384,calc_error_lowrie3(w0),calc_error_lowrie3(w1),calc_error_lowrie3(w2)
...
oplot,1/wlog(*,0),wlog(*,3),psym=-6,thick=3
xyouts,0.017,0.05,'1st order slope'
oplot,[0.017],[0.0063],psym=4,thick=3 & xyouts,0.02,0.006,'Godunov, cond'
oplot,[0.017],[0.0083],psym=5,thick=3 & xyouts,0.02,0.008,'Linde, cond'
oplot,[0.017],[0.0103],psym=6,thick=3 & xyouts,0.02,0.010,'Linde, radcond'
close_device,/pdf

; 2. Create 2D figure to demonstrate the AMR grids

filename = resdir + 'Godunov_cond_96/GM/z*.outs'
func='te'
physics='hd33'
...
filename= resdir+'Godunov_cond_???/GM/cut*.outs'
.r getpict
