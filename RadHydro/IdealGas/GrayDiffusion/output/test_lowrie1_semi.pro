...
npict=100
bottomline=0
set_device, resdir+'Trad_conservative.eps', /epe, /land
...
npict=100
bottomline=0
set_device, resdir+'Tgas_conservative.eps', /epe, /land
filename = resdir+'CONS/72/GM/cut*.outs'
.r getpict
...
npict=100
bottomline=0
set_device, resdir+'Trad_nonconservative.eps', /epe, /land
...
npict=100
bottomline=0
set_device, resdir+'Tgas_nonconservative.eps', /epe, /land
filename = resdir+'NONCONS/72/GM/cut*.outs'
.r getpict
plot,x,w(*,3),linestyle=0,xtitle='x',ytitle='gas temperature',charsize=2, $
     title="Lowrie's test 1 with constant opacities",thick=3
