...
.r getpict
printf,99,96,calc_error_1d(w)
filename=resdir+'192/GM/cut*.outs'
.r getpict
printf,99,192,calc_error_1d(w)
filename=resdir+'384/GM/cut*.outs'
.r getpict
printf,99,384,calc_error_1d(w)
;filename=resdir+'768/GM/cut*.outs'
;.r getpict
;printf,99,768,calc_error_1d(w)
...
oplot,[1e-3,1e-1],[3e-3,3e-1],linestyle=2,thick=3
