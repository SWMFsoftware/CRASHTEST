...
print, 20, total(abs(w0(*,*,1)-ref))/n, total(abs(w0(*,*,2)-ref))/n
print, 40, total(abs(w1(*,*,1)-ref))/n, total(abs(w1(*,*,2)-ref))/n
print, 80, total(abs(w2(*,*,1)-ref))/n, total(abs(w2(*,*,2)-ref))/n
